function initContactValidation(){
    ...
    if(!contactModal || !contactForm || !contactName || !contactEmail || !contactEmail || !formMessage){
        console.log("Contactc form element not found");
        return;
    }
    ...
    contactForm.addEventListener("submit",function(event){
        ...
        formMessage.classList("text-green-500");
